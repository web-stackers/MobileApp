...
const CompletedAfterRating = ({navigation, route}) => {
  const {fname, lname, rating, description, id, state, jobType} = route.params;
  const GoBack = () => {
    navigation.pop(1);
  };
  ...
  return (
    <SafeAreaView style={styles.flexContainer}>
      ...
      <View style={styles.menuWrapper}>
        ...
        <Separator />
        <View style={styles.menuItem}>
          <Text style={styles.menuItemSubtitle}>Reason for cancellation</Text>
        </View>
        <View style={styles.menuItem}>
        ...
        <Separator />
        <View style={styles.menuItem}>
          <Text style={styles.menuItemSubtitle}>Cancellation Date</Text>
        </View>
        <View style={styles.menuItem}>
...
export default CompletedAfterRating;
