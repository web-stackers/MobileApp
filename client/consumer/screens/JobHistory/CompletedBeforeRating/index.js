...
const CompletedBeforeRating = ({navigation, route}) => {
  ...
  return (
    <SafeAreaView style={styles.flexContainer}>
      ...
      <View style={styles.infoBoxWrapper}>
        <View
          ...
          <Title style={{color: '#FFFFFF'}}>
            {rating ? rating : '0'} <Icon name="star" color="#652C9E" size={22} />
            {''}
          </Title>
        ...
        <View style={styles.infoBox}>
          <View style={styles.btngrp}>
            <Sbutton primary={true} text="Rate job" />
          </View>
        </View>
      </View>
      ...
      <View style={styles.menuWrapper}>
        ...
        <Separator />
        <View style={styles.menuItem}>
          <Text style={styles.menuItemSubtitle}>Quotation accepted date</Text>
        </View>
        <View style={styles.menuItem}>
        ...
        <Separator />
        <View style={styles.menuItem}>
          <Text style={styles.menuItemSubtitle}>Work finished date</Text>
        </View>
        <View style={styles.menuItem}>
          <Text style={styles.menuItemText}>Date</Text>
        </View>
        <Separator />
        <View style={styles.menuItem}>
          <Text style={styles.menuItemSubtitle}>Total amount</Text>
        </View>
        <View style={styles.menuItem}>
...
export default CompletedBeforeRating;
